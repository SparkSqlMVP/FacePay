...
namespace DF_FaceTracking.cs
{
    public class FaceTextOrganizer
    {
        ...
        private Intel.RealSense.RectI32 m_rectangle;
        ...
        public void ChangeFace(int faceIndex, Intel.RealSense.Face.Face face, int imageHeight, int imageWidth)
        {
            ...
            Intel.RealSense.Face.DetectionData fdetectionData = face.Detection;
            ...
            {
                m_rectangle = fdetectionData.BoundingRect;
