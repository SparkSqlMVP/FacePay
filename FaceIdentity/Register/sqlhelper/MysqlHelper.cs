...
namespace FacePay.Tools.helper
{
...
        public static readonly string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["mysqlcon"].ToString();
